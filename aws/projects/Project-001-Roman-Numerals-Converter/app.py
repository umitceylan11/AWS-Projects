...
def main_post():
    if request.method=='POST':               
        alpha = request.form['number']       #tablodan girilen degeri cekme. number ismi:html'den alindi
        if not alpha.isdecimal():            #decimal olup olmadigi
            return render_template('index.html', developer_name='Umit', not_valid=True)  #index.html'i dolduruyoz ve ekran asagisinda yazan ikazi iptal ediyoz
        number=int(alpha)
